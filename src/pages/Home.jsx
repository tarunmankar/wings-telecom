    ...
    <div className="page page-container">
      <div className="hero">
        ...
        <div className="hero-wrap">
          <AnimatedSection className="hero-content">
            <div className="hero-badge"><span className="hero-badge-dot"></span>Gujarat &amp; Madhya Pradesh Operations</div>
            <h1>Powering<br/><span className="hl">India's</span><br/>Network<br/>Infrastructure</h1>
            <p>Specialized telecom field services — equipment installation, dismantling, solar power &amp; scrap management. Trusted across 350+ tower sites.</p>
        ...
        <AnimatedSection delay={0.2} className="hero-stats">
          <div className="stat-item"><div className="stat-num">350+</div><div className="stat-label">Sites Completed</div></div>
          <div className="stat-item"><div className="stat-num">3+</div><div className="stat-label">Years Experience</div></div>
          <div className="stat-item"><div className="stat-num">2</div><div className="stat-label">States Active</div></div>
      ...
      <section>
        ...
        <div className="why-grid">
          <AnimatedSection delay={0.1} className="why-card"><div className="why-icon">🏗️</div><h3>Field Expertise</h3><p>Hands-on experience across 350+ telecom tower sites in Gujarat and Madhya Pradesh. We know the terrain, the equipment, and the timelines.</p></AnimatedSection>
